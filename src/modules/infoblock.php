                ...
                <div class="infoblock__row">
                    <div class="infoblock__item_content">
                        ...
                        <p>
                            ...
                            Aperiam
                            asperiores doloremque dolorum, expedita repellendus velit? Amet aperiam assumenda beatae
                            dicta
                    ...
                    <div class="infoblock__item_content">
                        <div class="image_blur image_blur--off"><img src="./assets/img/tools/1.jpg" alt="Картинка"
                                                      data-description="Подпись к картинке 2 Подпись к картинке 2 Подпись к картинке 2 Подпись к картинке 2">
                        </div>
                    </div>
                </div>
            </div>
